        ...
        try:
            ...
            for url in pending_urls:
                ...
                try:
                    ...
                    if self.history_store and self.event_id:
                        item_meta = {"drill": drill_meta}
                        if is_inline_payload:
                            item_meta["input_fee_category"] = inline_fee_category
                            item_meta["input_meta"] = inline_payload_meta
                            item_meta["input_payload"] = _trim_json_for_history(payload)
                        self.history_store.add_item(
                            self.event_id,
                            url,
                            matched_skill,
