...
V12 对应 Git 标签：`v12`。运行默认使用：

- 后端：`http://127.0.0.1:8000/`
- 前端：`http://127.0.0.1:5175/`

版本说明见：[docs/versions/v12.md](docs/versions/v12.md)
...
- 发布一个版本：打 tag（例如 `v13`），并新增版本说明文件 `docs/versions/v13.md`
- 同步快照（双保险）：在 `_versioning/source/AI-DCP-src-v13/` 另存一份源码快照（不包含 `node_modules/dist/venv/.run/data/logs/.env` 等）
